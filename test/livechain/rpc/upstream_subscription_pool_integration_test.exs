defmodule Livechain.RPC.UpstreamSubscriptionPoolIntegrationTest do
  ...
  alias Livechain.Testing.MockWSProvider
  ...
  setup do
    ...
    on_exit(fn ->
      ...
      case Registry.lookup(Livechain.Registry, {:chain_supervisor, test_chain}) do
        [{pid, _}] ->
          DynamicSupervisor.terminate_child(Livechain.RPC.Supervisor, pid)
      ...
      Livechain.Config.ConfigStore.unregister_chain_runtime(test_chain)
