defmodule LassoWeb.Components.NetworkStatusLegend do
  ...
  def legend(assigns) do
    ~H"""
    <div class="bg-gray-900/20 border-gray-700/50 absolute bottom-4 right-4 rounded-lg border p-4 shadow-xl backdrop-blur-sm lg:right-6 xl:left-1/2 xl:right-auto xl:-translate-x-1/2">
