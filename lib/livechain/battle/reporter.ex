defmodule Livechain.Battle.Reporter do
  @moduledoc """
  ...
  defp compute_comparison(current, baseline) do
    ...
    %{
      success_rate_delta: calculate_delta(current.requests.success_rate, baseline.requests.success_rate),
      p95_latency_delta: calculate_delta(current.requests.p95_latency_ms, baseline.requests.p95_latency_ms)
    }
  end
