defmodule Lasso.Core.Benchmarking.Metrics do
  ...
  """
  @spec record_success(String.t(), chain, provider_id, method, non_neg_integer(), recording_opts) ::
          :ok
  ...
  """
  @spec record_failure(String.t(), chain, provider_id, method, non_neg_integer(), recording_opts) ::
          :ok
