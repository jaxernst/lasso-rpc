defmodule LivechainWeb.Plugs.ObservabilityPlug do
  @moduledoc """
  ...
  defp inject_metadata_headers(conn, request_context) do
    ...
    case Livechain.RPC.Observability.encode_metadata_for_header(metadata) do
      {:ok, encoded} ->
  ...
  defp build_metadata(request_context) do
    Livechain.RPC.Observability.build_client_metadata(request_context)
  end
end
